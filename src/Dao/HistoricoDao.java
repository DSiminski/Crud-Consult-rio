    ...
    public List<Historico> findAllHistorico(){
        ...
        try {
            ...
            while (resultSet.next()){
                ...
                Agendamento agendamento = agendamentoDao.findByIdAgendamento(resultSet.getLong("id_agenda"));
                historico.setAgenda(agendamento);
    ...
    public Historico findByIdHistorico(Long historico_id){
        ...
        try {
            ...
            while (resultSet.next()){
                ...
                Agendamento agendamento = agendaDao.findByIdAgendamento(resultSet.getLong("id_agenda"));
                historico.setAgenda(agendamento);
